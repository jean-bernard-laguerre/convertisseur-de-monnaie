...
lbl_Montant = Label(conv_main, text="Montant :").grid(row=1, column=0)
montant = Entry(conv_main, width=30)
montant.grid(row=1, column=1)

lbl_Monnaie_init = Label(conv_main, text="De :").grid(row=2, column=0)
Monnaie1 = OptionMenu(conv_main, monnaie_Depart, *liste_devise)
Monnaie1.config(width=24)
Monnaie1.grid(row=2, column=1)

lbl_Monnaie_conv = Label(conv_main, text="A :").grid(row=3, column=0)
...
lbl_nom_devise = Label(ajt_devise, text="Nom :").grid(row=1, column=0)
nom_devise = Entry(ajt_devise, width=30)
nom_devise.grid(row=1, column=1)

lbl_valeur_devise = Label(ajt_devise, text="Taux :").grid(row=2, column=0)
